package ec.edu.ups.demoJakartaa.services;

import java.util.List;
import ec.edu.ups.demoJakartaa.business.GestionClientes;
...
public class ClientesService {
    ...
    public Response delete(@PathParam("cedula") String cedula) {
        try {
            ...
            return Response.ok().entity(new Respuesta(Respuesta.OK, "Cliente Eliminado")).build();
        } catch (Exception e) {
            e.printStackTrace();
            return Response.status(503).entity(new Respuesta(Respuesta.ERROR, "Error en BD")).build();
        }
