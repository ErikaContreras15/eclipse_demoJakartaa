...
a persistence unit "demoJakartaaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoJakartaa/pom.xml":
...
artifact ("demoJakartaa.war") is already built. You can build
